	                ...
	                <div class="ibox">
	                    <div class="ibox-content">
	                    	<form class="form-horizontal m-t" id="eqTestForm" action="${basePath }/result/employeeResult/addEmployeeResult" method="post">
	                              ...
	                              <input type="hidden" name="evalType" value="ed" />
			                                          ...
			                                          <h3>${eqb.eqbbasic }<small>——${eqb.eqsstandard }</small>&nbsp;&nbsp;<span class="badge badge-primary">(${eqb.eqsscale }%)</span></h3> 
		                                        	    <c:forEach items="${eqb.employeeOptionList }" var="eo"  varStatus="statusO">
				                                        	<p class="text-muted">
					                                        	...
					                                        	>
					                                        		${eo.eonum }&nbsp;.&nbsp;<span style="font-size:16px;font-weight: 400;">[${eo.eoname }]
					                                        		</span>&nbsp;${eo.eodescribe }.&nbsp;&nbsp;<span class="badge badge-primary">
			                                        	...
			                                        	<div class="form-group">
							                                <div class="col-sm-3">
							                                    <div class="input-group m-b">
							                                        ...
							                                        <input name="erdweight${eqb.eqsid }" minlength="1" lonum="0" upnum="10" placeholder="请输入评分" 
