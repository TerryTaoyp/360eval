...
<body class="gray-bg">
	                    ...
	                    <div class="ibox-content">
							...
							<div class="btn-group hidden-xs" id="tableToolbar" role="group">
	                              ...
	                              <table 
	                              	id="table" 
	                              	data-toggle="table" 
	                              	data-url="${basePath}/eval/employeeQuestionBasic/getEqdList" 
   ...
   <!-- 全局js -->
    ...
    function refresh(){
    	$("#table").bootstrapTable('refresh',{url: "${basePath}/eval/employeeQuestionBasic/getEqdList"});
    }
    window.operateEvents = {
	    		 'click .stest': function (e, value, row) {
	    	             layer.open({
	    	                 type: 2,
	    	                 title: ['&nbsp;&nbsp;'+row.zname+'部门经理测评', 'text-align:center;margin:0 auto;font-size:24px;'],
	    	                 shadeClose: false,
	    	                 shade: [0.3, '#393D49'],
	    	                 fix: true,
	    	                 ...
	    	                 area: ['85%', '85%'],
	    	                 //closeBtn: 2,
	    	                 content: '${basePath}/eval/employeeQuestionBasic/eqdTest?dtid='+row.dtid+"&rid="+row.rid+"&eid="+row.eid
	    	             });
	    	      },
    	                ...
    	                closeOnConfirm: false
    	            	 ...
    	            	 $.ajax({
     		     			...
     		     			success: function(data) {
     		     				swal({title:"部门经理测评",text:"提交成功!",timer:2000, type: "success"});
     		     				refresh();
     		     			},
             ...
             swal({
	                ...
	                closeOnConfirm: false
	            	 ...
	            	 $.ajax({
		     			...
		     			async: false,
		     			success: function(data) {
		     				swal({title:"部门经理测评",text:"批量提交成功!",timer:2000, type: "success"});
		     				refresh();
		     			},
		     			error: function(request) {
		     			}
